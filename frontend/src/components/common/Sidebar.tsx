...
export const Sidebar: React.FC<SidebarProps> = ({ isOpenMobile, onCloseMobile }) => {
  ...
  const navItems = [
    ...
    { label: 'Comments & Feedback', icon: MessageSquare, path: '/student/feedback' },
    { label: 'Faculty Mentoring', icon: Users, path: '/student/mentoring' },
    { label: 'My Subscription', icon: ShieldCheck, path: '/student/subscription' },
